                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
						...
						<?php
							//compute cummulative outstanding for each individual
							$oracle_no = $user->oracle_number;
							$month = $user->expected_monthly_repayment_month;
							$sum_outstanding = 0;
							$sql = "select outstanding from merged_result where oracle_number='$oracle_no' and expected_monthly_repayment_month='$month'";
							$query = $this->db->query($sql);
							foreach($query->result() as $value)
							{
								$sum_outstanding = $sum_outstanding + $value->outstanding;
						...
						<td><?php echo "&#8358;".number_format($sum_outstanding,2) ; ?></td>
