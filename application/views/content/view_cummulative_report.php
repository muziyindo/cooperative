            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
				  ...
				  <form action="<?php echo site_url('main/search/cummulative_report/view_cummulative_report'); ?>" method="post" accept-charset="utf-8">
				  <div class="row">
						<div class="col-xs-3">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
						...
						<td><?php echo "&#8358;".number_format($user->cumm_deduction,2); ?></td>
						<td><?php echo "&#8358;".number_format($user->cumm_outstanding,2); ?></td>
						<td><?php echo "&#8358;".number_format($user->cumm_remittance,2); ?></td>
